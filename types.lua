...
---@field ipl? GarageIplData --- IPL data for interior garage mode

---@class GarageIplData
---@field enabled boolean --- Whether this garage uses IPL mode
---@field label? string --- Friendly IPL label selected from Config.GarageIpls
---@field model? string|string[] --- IPL name or list requested on clients
---@field bucket? integer --- Routing bucket used by this garage interior
---@field preview? vector4 --- Preview point for admin model selection
---@field entry? vector4 --- Legacy exterior entry point
---@field exit? vector4 --- Legacy interior exit point
---@field entries? GarageIplEntry[] --- Exterior entry points available for this IPL garage
---@field floors? GarageIplFloor[] --- Interior floor points available when entering the IPL
---@field parkingSpots? GarageIplParkingSpot[] --- Interior parking interaction points
---@field allowVehicle? boolean --- Legacy vehicle access fallback

---@class GarageIplEntry
---@field label string --- Friendly entry name
---@field coords vector4 --- Exterior entry point
---@field mode? "ped"|"vehicle"|"both" --- Allowed access type

---@class GarageIplFloor
---@field label string --- Friendly floor name
---@field coords vector4 --- Interior floor teleport point
---@field mode? "ped"|"vehicle"|"both" --- Allowed exit/entry target type

---@class GarageIplParkingSpot
---@field label string --- Friendly parking spot name
---@field coords vector4 --- Parking spot interaction point
---@field radius? number --- Interaction radius for parking
