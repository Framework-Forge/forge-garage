...
local function spawnvehicle ( data )
    ...
    TriggerServerEvent("forge_garage:server:removeFromPoliceImpound", vehData.plate)
        ...
        for k,v in pairs(vehicle) do
            ...
            context.options[#context.options+1] = {
                ...
                onSelect = function ()
                    ...
                    local context2 = {
                        id = "forge_garage:policeImpound.action",
                        title = garage:upper(),
                        menu = "forge_garage:policeImpound",
                        onBack = deletePreviewVehicle,
                        onExit = deletePreviewVehicle,
                        options = {
                            {
                    ...
                    if paid < 1 then
                        context2.options[#context2.options+1] = {
                            ...
                            onSelect = function ()
                                ...
                                TriggerServerEvent("forge_garage:server:policeImpound.sendBill", citizenid, fine, plate)
                            end
                        }
                    elseif paid > 0 then
                        context2.options[#context2.options+1] = {
